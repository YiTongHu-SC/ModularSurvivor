...
namespace Core.Assets
{
    ...
    public class LoadingPipeline
    {
        ...
        public LoadingPipeline(params LoadingPhase[] phases)
        {
            ...
            _totalWeight = 0f;
            foreach (var phase in _phases) _totalWeight += phase.Weight;
        }
        ...
        /// </summary>
        public IEnumerator ExecuteCoroutine(Action<LoadingStatus> progressCallback = null)
        {
    ...
    public static class LoadingPipelineBuilder
    {
        ...
        {
            var phases = new List<LoadingPipeline.LoadingPhase>();
